//
//  poupcountryViewController.swift
//  Soaq
//
...
class poupcountryViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Sharedd.shareddd.country = Countrylist[indexPath.row]
